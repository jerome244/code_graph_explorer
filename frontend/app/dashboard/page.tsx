                  ...
                  <article key={p.id} style={cardStyle}>
                    ...
                    <div style={cardBodyStyle}>
                      ...
                      <div style={cardActionsStyle}>
                        <a href={`/graph?projectId=${p.id}`} style={primaryBtnStyle}>Open in Graph</a>
                        <a href={`/projects/${p.id}/share`} style={ghostBtnStyle}>Share</a>
                      </div>
                    </div>
                  </article>
                ))}
...
const loadingStyle: CSSProperties = { fontSize: 16, color: "#4b5563", textAlign: "center" };
...
const sectionStyle: CSSProperties = { margin: "12px 0 24px" };
...
const sectionTitleStyle: CSSProperties = { fontSize: 22, margin: 0, fontWeight: 700, color: "#111827" };

const viewAllLinkStyle: CSSProperties = { fontSize: 14, textDecoration: "none", color: "#2563eb" };
...
const cardBodyStyle: CSSProperties = { padding: 12, display: "flex", flexDirection: "column", gap: 6 };

const cardTitleStyle: CSSProperties = { margin: 0, fontSize: 16, fontWeight: 700, color: "#111827", lineHeight: 1.25 };

const cardSubtitleStyle: CSSProperties = { margin: 0, fontSize: 13, color: "#6b7280" };

const metaStyle: CSSProperties = { margin: 0, fontSize: 12, color: "#9ca3af" };

const cardActionsStyle: CSSProperties = { marginTop: 8, display: "flex", gap: 8 };
